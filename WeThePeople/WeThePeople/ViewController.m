...
-(IBAction)initialPetitionsDownload:(id)sender {
    ...
    //NSString *petitionsString = [[PETITIONS_URL stringByAppendingString:@"&limit=1000&offset=0;"];
    ...
    NSURL *download_url = [NSURL URLWithString:PETITIONS_URL];
...
//NSLog(@"ResponseString: %@", responseString);
        ...
        for (int i = 0; i<[peititionListingResultsArray count]; i++) {
            ...
            NSLog(@"Signatures Needed:%@", [[peititionListingResultsArray objectAtIndex:i] objectForKey:@"signaturesNeeded"]);
