...
-(void)viewWillAppear:(BOOL)animated {
    ...
    NSLog(@"favoriteIssueSet: %@", favoriteIssuesSet);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *signaturesNeededText = [NSString stringWithFormat:@"Signatures Count: %@", [[peitionTableViewArray objectAtIndex:indexPath.row] objectForKey:@"signatureCount"] ];
