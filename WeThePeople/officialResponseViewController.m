...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //display the status
    statusLabel.text = [NSString stringWithFormat:@"Official Response"];
    ...
    daysLeftLabel.text = [NSString stringWithFormat:@"%d days since petition end", numberOfDays];
...
//    filterButton.layer.zPosition = 3;
...
//    [filterButton addTarget:self action:@selector(filterButtonTouched:) forControlEvents:UIControlEventTouchUpOutside];
